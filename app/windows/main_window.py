...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        self.library_panel.set_media_library_path(
            self._settings.value("media_library_path", "", type=str)
        )
    ...
    def _build_ui(self) -> None:
        ...
        self.workspace.setSizes([480, 720])
    ...
    def _save_media_library_path(self, library_path: str) -> None:
        self._settings.setValue("media_library_path", library_path)
    ...
    def _import_series(self, series_path: str) -> None:
    ...
    def _add_selected_to_queue(
        ...
        self.control_console.add_episodes(episodes, output_paths)
    ...
    def _on_conversion_finished(
        ...
        self.control_console.mark_result(episode, result)
